...
async function generateEmail(candidate, triggerReason) {
  ...
  const prompt = `You are a friendly, professional recruiter at Zeople writing a post-offer follow-up email.
...
<p style="font-size:12px;color:#999">You're receiving this from Zeople as part of our candidate engagement programme. Reply to this email if you have any questions.</p>
</div>`;
}
