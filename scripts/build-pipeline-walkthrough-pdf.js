/**
 * scripts/build-pipeline-walkthrough-pdf.js
 *
 * Renders dist/Zeople-Pipeline-Walkthrough.html to a single-page PDF.
 *
 * Run with:  node scripts/build-pipeline-walkthrough-pdf.js
 */
...
const HTML = path.join(ROOT, 'dist', 'Zeople-Pipeline-Walkthrough.html');
const OUT  = path.join(ROOT, 'dist', 'Zeople-Pipeline-Walkthrough.pdf');
...
if (!fs.existsSync(HTML)) {
  console.error(`❌ HTML not found at ${HTML}. Run scripts/build-pipeline-walkthrough-html.js first.`);
  process.exit(1);
}
